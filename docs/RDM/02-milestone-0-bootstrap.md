...
| 2 | `Config` dataclass + `Config Repository` | CONFIGREPOSITORY-01, CONFIGREPOSITORY-02, CONFIGREPOSITORY-03 | sq_cfg01, sq_cfg02, sq_cfg03 |
| 3 | `Session` dataclass + `Session Repository` | SESSIONSERVICE-01, SESSIONSERVICE-02, SESSIONSERVICE-03, SESSIONSERVICE-04 | sq_ssn01, sq_ssn02, sq_ssn03, sq_ssn04 |
