...
| -------- | ------ | ---- | ---- | ------- | ----- |
| Session | List | GET | `/v1/sessions` | SSN-03 | Paginated (AIP-158) |
| Session | Get | GET | `/v1/sessions/{session_id}` | SSN-02 | Single session by ID |
...
| Pagination | AIP-158, UC SSN-03 (List Sessions) |
