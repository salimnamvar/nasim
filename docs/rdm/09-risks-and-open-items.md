...
| R2 | MCP protocol evolution | MCPToolAdapter breaks | MCP SDK handles versioning; adapter pattern |
...
| R5 | Tool permission bypass | Security vulnerability | PermissionGate tests with bypass attempts |
